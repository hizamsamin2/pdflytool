...
export const metadata = {
  title: "About",
  description: "Learn about PDFly — a free, privacy-first PDF tools platform.",
};

export default function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      <h1 className="text-4xl font-bold">About PDFly</h1>
      ...
      <div className="mt-8 space-y-8">
        <section>
          ...
          <p className="mt-3 text-muted-foreground">
            PDFly was created to solve a simple problem: most online PDF tools require you to upload sensitive
            documents to unknown servers. We built PDFly so that all processing happens directly in your browser —
        ...
        <section>
          ...
          <p className="mt-3 text-muted-foreground">
            PDF manipulation is a basic utility everyone needs. We think it should be free. To keep PDFly free,
        ...
        <section>
          ...
          <p className="mt-3 text-muted-foreground">
            PDFly is built using modern web technologies including Next.js, TypeScript, pdf-lib, and PDF.js. All PDF
